...
const RightHero = () => {
  ...
  return (
    <section className="basis-1/2" ref={ref}>
      <div className="relative bg-gradient-to-b from-[#171532] to-[#08090d] backdrop-blur-md border border-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow">
        {/* Header */}
