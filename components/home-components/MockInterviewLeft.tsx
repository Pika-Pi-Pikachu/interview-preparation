...
const MockInterviewLeft = () => {
  return (
    <div className="relative">
      <div className="relative bg-gradient-to-b from-[#171532] to-[#08090d] backdrop-blur-md border border-gray-700 rounded-2xl p-6 shadow-2xl">
        {/* Background glow */}
        ...
        <div className="mt-6 flex space-x-4">
          ...
          <motion.button className="flex-1 bg-gradient-to-b from-[#171532] to-[#08090d] backdrop-blur-md border border-gray-700 hover:bg-indigo-700 py-3 rounded-md transition-colors flex items-center justify-center gap-2 font-medium text-white" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            Continue
          </motion.button>
        </div>
      </div>
